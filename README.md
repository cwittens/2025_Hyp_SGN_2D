...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18038218.svg)](https://doi.org/10.5281/zenodo.18038218)
...
@online{wittenstein2026gpu,
  title={{GPU}-Accelerated Energy-Conserving Methods for the Two-Dimensional Hyperbolized Serre--Green--Naghdi Equations},
...
and either periodic or reflecting boundary conditions. The hyperbolic
...
operators to construct semi-discretizations that conserve the total water mass
